    ...
    async extractJobUrls(): Promise<JobUrl[] | null> {        
        const responese =await fetch("https://api-recruiter.recruiter.co.kr/position/v1/jobflex", {
            "headers": {
                ...
                "cookie": "_ga_CQZEJCRL96=GS2.1.s1758477402$o3$g0$t1758477402$j60$l0$h0; _ga_HCRNGQLH50=GS2.1.s1759542841$o1$g0$t1759542841$j60$l0$h0; _ga=GA1.3.1265182742.1758468802",
