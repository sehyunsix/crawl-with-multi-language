...
class SktJobUrlExtractor extends ApiUrlExtractor {
  constructor() {
    super("www.skcareers.com");
  }
  ...
  async extractJobUrlsFromApi(): Promise<JobUrl[]> {
    const responese = await fetch("https://www.skcareers.com/Recruit/GetRecruitList", {
      headers: {
        ...
        cookie:
          "_ga=GA1.1.1440046652.1759246436; _culture=ko-KR; _ga_TDN9G4BW97=GS2.1.s1761125596$o7$g1$t1761125680$j37$l0$h0",
...
export default sktJobUrlExtractor;
